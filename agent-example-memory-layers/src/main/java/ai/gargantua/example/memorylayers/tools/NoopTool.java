package ai.gargantua.example.memorylayers.tools;
 ...
 * {@code allowed-tools: [echo]} on every skill in this example. The
 * focus is on the memory subsystem, not tool dispatch.
 */
@Component
